...
## [7.0.6](https://github.com/sentioxyz/revm/compare/revm-database-interface-v7.0.5...revm-database-interface-v7.0.6) - 2025-09-16

### Other

- *(database)* avoid panic by conditionally using block_in_place ([#2927](https://github.com/sentioxyz/revm/pull/2927))
