...
mod tests {
    ...
    fn test_call_override_inspector() {
        ...
        inspector.call_override.push(Some(CallOutcome::new(
            InterpreterResult::new(InstructionResult::Return, [0x01].into(), Gas::new(100_000, false)),
            0..1,
        )));
        inspector.call_override.push(None);
        inspector.create_override.push(Some(CreateOutcome::new(
            InterpreterResult::new(InstructionResult::Revert, [0x02].into(), Gas::new(100_000, false)),
            Some(Address::ZERO),
        )));
